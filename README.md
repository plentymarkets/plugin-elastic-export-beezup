...
# Elastic Export BeezUp Plugin for plentymarkets 7

This is the elastic export BeezUp plugin for plentymarkets 7 which extends the list of possible export formats. 
